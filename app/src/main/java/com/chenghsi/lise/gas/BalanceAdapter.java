...
public class BalanceAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            holder = new ViewHolder(
                    (CheckedTextView) convertView.findViewById(R.id.checkBox_name),
        ...
        holder.checkBox_name.setText(balance.getName());
    ...
    private class ViewHolder {
        ...
        public ViewHolder(CheckedTextView checkBox_name, TextView tv_cylinder1, TextView tv_cylinder2,
